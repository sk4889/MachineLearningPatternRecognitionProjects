...
for i in iters:  
    if algo_metrics[i] == 'Perceptron':
        clf = Perceptron()
        clf.fit(mnist_training_data_0_1,mnist_training_target_0_1)
        scores = clf.score(mnist_training_data_0_1,mnist_training_target_0_1)
        scores_list_0_1.append(scores)

        clf.fit(mnist_training_data_7_9,mnist_training_target_7_9)
        scores = clf.score(mnist_training_data_7_9,mnist_training_target_7_9)
