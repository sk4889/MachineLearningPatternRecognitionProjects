...
#plot3 for Class 0 & 1 pair under Kmeans
...
scores_list_0_1_cl_fi_co_la= [0.644, 0.6655, 0.685, 0.6795, 0.6675]
...
scores_list_0_1_co_fi_cl_la= [0.849, 0.883, 0.8945, 0.8975, 0.9145]
