...
#plot2 for Class 7 & 9 pair under Kmeans++
...
scores_list_7_9_cl_fi_co_la= [0.754, 0.725, 0.7105, 0.748, 0.736]
...
scores_list_7_9_co_fi_cl_la= [0.919, 0.935, 0.9385, 0.949, 0.9525]
