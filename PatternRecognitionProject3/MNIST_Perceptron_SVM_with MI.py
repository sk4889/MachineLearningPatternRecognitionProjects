...
top_80_features_based_0_1 = mi_features_0_1.argsort()[::-1][:500]
top_80_features_based_7_9 = mi_features_7_9.argsort()[::-1][:500]
...
# Three algo are used
algo_metrics = ['Perceptron','Hard SVM', 'Soft SVM']
...
for i in iters:  
    if algo_metrics[i] == 'Perceptron':
        clf = Perceptron()
        clf.fit(new_mnist_training_data_0_1,mnist_training_target_0_1)
        scores = clf.score(new_mnist_training_data_0_1,mnist_training_target_0_1)
        scores_list_0_1.append(scores)

        clf.fit(new_mnist_training_data_7_9,mnist_training_target_7_9)
        scores = clf.score(new_mnist_training_data_7_9,mnist_training_target_7_9)
        scores_list_7_9.append(scores)
    
    elif algo_metrics[i] == 'Hard SVM':
        clf = svm.LinearSVC(C=32000)
        clf.fit(new_mnist_training_data_0_1,mnist_training_target_0_1)
        scores = clf.score(new_mnist_training_data_0_1,mnist_training_target_0_1)
        scores_list_0_1.append(scores)
...
scores_dict_0_1['Perceptron'] = round(scores_list_0_1[0]*100) 
scores_dict_0_1['Hard SVM'] = round(scores_list_0_1[1]*100)  
scores_dict_0_1['Soft SVM'] = round(scores_list_0_1[2]*100) 
         
scores_dict_7_9['Perceptron'] = round(scores_list_7_9[0]*100) 
scores_dict_7_9['Hard SVM'] = round(scores_list_7_9[1]*100)  
scores_dict_7_9['Soft SVM'] = round(scores_list_7_9[2]*100)  
