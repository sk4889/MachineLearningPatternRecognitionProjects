...
for i in iters:  
    if algo_metrics[i] == 'GNB':
        gnb = GaussianNB()
        gnb.fit(mnist_training_data_0_1,mnist_training_target_0_1)
        mnist_pred_target_0_1 = gnb.predict(mnist_test_data_0_1)      
        scores = metrics.accuracy_score(mnist_test_target_0_1,mnist_pred_target_0_1)
        scores_list_0_1.append(scores)

        gnb.fit(mnist_training_data_7_9,mnist_training_target_7_9)
        mnist_pred_target_7_9 = gnb.predict(mnist_test_data_7_9)      
