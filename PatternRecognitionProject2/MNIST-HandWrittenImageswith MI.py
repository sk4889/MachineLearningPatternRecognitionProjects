...
top_80_features_based_0_1 = mi_features_0_1.argsort()[::-1][:80]
top_80_features_based_7_9 = mi_features_7_9.argsort()[::-1][:80]
...
# Four algo are used
algo_metrics = ['knn-L1-accuracyscore','knn-L2-accuracyscore','knn-JaccardScore','decisiontree']
...
for i in iters:  
    if algo_metrics[i] == 'knn-L1-accuracyscore':
        ...
        knn.fit(new_mnist_training_data_0_1,mnist_training_target_0_1)
        mnist_pred_target_0_1 = knn.predict(new_mnist_test_data_0_1)
        scores = metrics.accuracy_score(mnist_test_target_0_1,mnist_pred_target_0_1)
        scores_list_0_1.append(scores)
        
        knn.fit(new_mnist_training_data_7_9,mnist_training_target_7_9)
        mnist_pred_target_7_9 = knn.predict(new_mnist_test_data_7_9)
    ...
    elif algo_metrics[i] == 'knn-JaccardScore':     
